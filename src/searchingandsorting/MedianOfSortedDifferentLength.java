...
public class MedianOfSortedDifferentLength {
	...
	static float findMedianUtil(int A[], int N, int B[], int M) {
		System.out.println("Length A= " + N + " Length B= " + M);
		if (N != 0) {
			for (int i : A)
				System.out.print(i + " ");
			System.out.println(" ");
		 ...
		 */
		System.out.println("A[mid]=" + A[idxA] + " B[mid]=" + B[idxB]);
		if (A[idxA] <= B[idxB])
	...
	public static void main(String[] args) {
		...
		System.out.printf("%f", findMedian(ar1, N, ar2, M));
	}
}
